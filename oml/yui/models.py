...
class Shouhin(models.Model):
    ...
    Kikaku = models.CharField(max_length=100,null=True,verbose_name='規格')
    Siresaki_cd = models.IntegerField(null=True)
    Siresaki_nm = models.CharField(max_length=100,null=True)
    Irisu = models.CharField(max_length=100,default=0)
...
class T_oml3(models.Model):
    ...
    Irai_day = models.CharField (max_length=10, verbose_name='依頼日', null=True)
    Busyo = models.CharField(max_length=80, verbose_name='部署')
    Irai_nm = models.CharField (max_length=80, verbose_name='依頼者', null=True)
    Houhou = models.CharField (max_length=80, verbose_name='方法', null=True)
    Syuka_kokyaku = models.CharField (max_length=200, verbose_name='出荷顧客', null=True)
    Hachu_nm = models.CharField (max_length=80, verbose_name='発注者', null=True)
    Bunrui = models.CharField (max_length=80, verbose_name='分類', null=True)
    Shouhin = models.ForeignKey(Shouhin, on_delete=models.PROTECT)
    Iri_su = models.IntegerField (verbose_name='入数', null=True)
    Case_su = models.IntegerField (verbose_name='C/S', null=True)
    Sum_su = models.IntegerField (verbose_name='合計数量', null=True)
    Kingaku = models.IntegerField (verbose_name='金額', null=True)
    Siresaki_cd = models.IntegerField (verbose_name='仕入先CD', null=True)
    Siresaki_nm = models.CharField (max_length=80, verbose_name='仕入先名', null=True)
    Hachu_day = models.CharField (max_length=10, verbose_name='発注日', null=True)
    Yotei_day = models.CharField (max_length=100, verbose_name='予定日', null=True)
    Nohin_day = models.CharField (max_length=10, verbose_name='納品日', null=True)
    Nohin_tanto_nm = models.CharField (max_length=80, verbose_name='納品担当者', null=True)
    Tokuisaki_shuka_day = models.CharField (max_length=10, verbose_name='得意先出荷日', null=True)
    Syoumikgn = models.CharField (max_length=10, verbose_name='賞味期限', null=True)
    Biko = models.CharField (max_length=10000, verbose_name='備考', null=True)
